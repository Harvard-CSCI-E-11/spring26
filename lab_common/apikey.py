...
This file implements the server side of a simple authentication system
based on an API_KEY and an API_SECRET_KEY.

The keys are stored in the database that is maintained by the file db.py.
