# SPDX-FileCopyrightText: 2025 Simson Garfinkel (Updated)
# SPDX-FileCopyrightText: 2023 Jeff Epler for Adafruit Industries
# SPDX-FileCopyrightText: 2023 Limor Fried for Adafruit Industries
#
# SPDX-License-Identifier: Unlicense
"""
This is the MOMENTO camera demo program provided by Adafruit,
with improved Wi-Fi and NTP handling by Simson Garfinkel.

Be sure to focus before shooting:
https://learn.adafruit.com/adafruit-memento-camera-board/fancy-camera
...
if wifi.radio.connected:
    ...
    current_offset_seconds = r.json()['offset'] # Returns -18000 (EST) or -14400 (EDT)
    utc_offset = current_offset_seconds // 3600
    print("Using ip-api.com, our UTC offset is",utc_offset)
