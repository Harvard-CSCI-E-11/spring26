...
def grade_student_vm(*,user_id,lab:str,email:str,ipaddr:str, key_pem:str):
    ...
    try:
        ...
        add_user_log(None, user_id, 'Grading lab {lab} ends')
        return summary
    finally:
        e11ssh.close()
